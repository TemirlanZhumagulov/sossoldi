          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "KazFinTracker does not collect any personal information or connect to the internet. Any information that you add in the app exist solely on your device and no where else.\n",
                  style: Theme.of(context)
                      .textTheme
                      .bodyMedium!
                      .copyWith(color: Theme.of(context).colorScheme.primary),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: 'help.kazfintracker@gmail.com',
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () {
                            launchUrl(Uri(
                              scheme: 'mailto',
                              path: 'help.kazfintracker@gmail.com',
                              queryParameters: {
